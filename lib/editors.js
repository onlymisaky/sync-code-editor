 ...
 */
const editorMap = {
  vscode: { name: 'Visual Studio Code', path: getAppDataPathWithCache('Code') },
  cursor: { name: 'Cursor', path: getAppDataPathWithCache('Cursor') },
  windsurf: { name: 'Windsurf', path: getAppDataPathWithCache('Windsurf') },
  trae: { name: 'Trae', path: getAppDataPathWithCache('Trae') },
  'trae-cn': { name: 'Trae CN', path: getAppDataPathWithCache('Trae CN') }
};
